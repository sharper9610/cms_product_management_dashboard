...
<footer class="landing-footer">
    ...
    <div class="container">
      <div class="row gx-0 gy-6 g-lg-10">
        <div class="col-lg-5">
          ...
          <p class="footer-text footer-logo-description mb-6">Most Powerful & Comprehensive 🤩 React NextJS
            Admin
  ...
  <div class="footer-bottom py-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      ...
      <div>
        <a href="{{ config('variables.githubFreeUrl') }}" class="footer-link me-4" target="_blank">
          <i class="icon-base ri ri-github-fill icon-18px"></i>
        </a>
        <a href="{{ config('variables.facebookUrl') }}" class="footer-link me-4" target="_blank">
          <i class="icon-base ri ri-facebook-circle-fill icon-18px"></i>
        </a>
        <a href="{{ config('variables.twitterUrl') }}" class="footer-link me-4" target="_blank">

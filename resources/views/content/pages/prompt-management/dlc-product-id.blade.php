...
@section('page-script')
  ...
  @vite('resources/assets/js/app-prompt-dlc-product-id-list.js')
@endsection
...
@section('content')
  ...
  <div class="card">
    <div class="card-header border-bottom">
      <h5 class="card-title mb-0">DLC Product IDs Prompt List</h5>
      ...
      <div class="offcanvas-body mx-0 flex-grow-0 h-100">
        <form class="add-new-user pt-0" id="addNewUserForm" onsubmit="return false">
          ...
          <div class="form-floating form-floating-outline mb-5 form-control-validation">
            <textarea id="add-prompt-template" class="form-control  description-area" name="template"
                      placeholder="Enter template"></textarea>
            <label for="add-prompt-template">Template</label>
          </div>
      ...
      <div class="offcanvas-body mx-0 flex-grow-0 h-100">
        ...
        <div class="form-wrapper">
          <form class="edit-user-form pt-0" id="editUserForm" onsubmit="return false">
            ...
            <div class="form-floating form-floating-outline mb-5 form-control-validation">
              <textarea id="edit-template" class="form-control edit-template description-area"

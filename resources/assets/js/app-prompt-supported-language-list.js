...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_user_table) {
    const dt_user = new DataTable(dt_user_table, {
      serverSide: true,
      ajax: {
        url: baseUrl+'settings/supported-lang-prompt-management',
        type: 'GET',
        beforeSend: function () {
  ...
  $('.datatables-users tbody').on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          url: baseUrl + 'settings/supported-lang-prompt-management/' + userId,
          type: "DELETE",
...
// Edit User Form Validation
  ...
  fvEdit.on('core.form.valid', function () {
    ...
    $.ajax({
      url: `${baseUrl}settings/supported-lang-prompt-management/${promptId}`,
      type: 'PUT',
      data: $form.serialize(),
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
  ...
  $.ajax({
    ...
    success: function (response) {
      if (response.success && offcanvasElement.length) {
        ...
        $("#offcanvasEditUser .edit-interface").val(response.prompt.interface);
        $("#offcanvasEditUser .edit-full_audio").val(response.prompt.full_audio);
        $("#offcanvasEditUser .edit-subtitles").val(response.prompt.subtitles);
